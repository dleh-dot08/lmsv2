...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4">
        <span class="text-muted fw-light">Master Data / Kelas /</span> Tambah Baru
    </h4>

    <div class="card mb-4">
        <h5 class="card-header">Form Tambah Kelas/Tingkatan</h5>
        <div class="card-body">
            <form method="POST" action="{{ route('grades.store') }}">
                ...
                <div class="mt-4">
                    <button type="submit" class="btn btn-primary me-2">Simpan Kelas</button>
