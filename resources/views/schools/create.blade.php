...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4">
        <span class="text-muted fw-light">Master Data / Data Sekolah /</span> Tambah Baru
    </h4>

    <div class="card mb-4">
        <h5 class="card-header">Form Pendaftaran Sekolah Baru</h5>
        <div class="card-body">
            <form method="POST" action="{{ route('schools.store') }}">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control @error('headmaster_name') is-invalid @enderror" id="headmaster_name" name="headmaster_name" value="{{ old('headmaster_name') }}" required>
                    ...
                    <div class="col-md-12">
                        ...
                        <textarea class="form-control @error('full_address') is-invalid @enderror" id="full_address" name="full_address" rows="3">{{ old('full_address') }}</textarea>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-select @error('pic_user_id') is-invalid @enderror" id="pic_user_id" name="pic_user_id">
                            <option value="">Pilih User PIC (Tersedia: {{ $availablePics->count() }})</option>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control @error('pic_position') is-invalid @enderror" id="pic_position" name="pic_position" value="{{ old('pic_position') }}" placeholder="Contoh: Koordinator PPDB / Staff Kurikulum">
                ...
                <div class="mt-4">
                    <button type="submit" class="btn btn-primary me-2">Daftarkan Sekolah</button>
